...
import net.mengells.simpleApiApp.ErrorResponse;
...
public class Controller {
    ...
    @OpenApi(
            ...
            tags = {"User"},
            requestBody = @OpenApiRequestBody(content = {@OpenApiContent(from = net.mengells.simpleApiApp.user.NewUserRequest.class)}),
            responses = {
